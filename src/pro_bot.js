...
bot.command('start', async (ctx) => {
    ...
    const buttons = [
        ...
        await ctx.replyWithPhoto({ source: './img/OI.jpeg' }, {
        ...
        console.error('text, /start:', e);
      // Обработка ошибки при выполнении команды /start
    }
});
addActionBot('button1', './img/bioSpace.jpeg', 'Привет мир');
addActionBot('button2', './img/log1.jpeg', 'Текст для кнопки 2');
addActionBot('button3', './img/log3.jpeg', 'Текст для кнопки 3');
addActionBot('button4', './img/pink.jpeg', 'Текст для кнопки 4');
